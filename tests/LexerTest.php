...
class LexerTest extends TestCase
{
    public static function dateProvider()
    {
        return [
            ...
            ['3rd friday jan', [new Token('day', '3rd'), new Token('word', 'friday'), new Token('word', 'jan')]],
            ['3rd thu jul', [new Token('day', '3rd'), new Token('word', 'thu'), new Token('word', 'jul')]],
            ...
            ['every 13', [new Token('word', 'every'), new Token('number', '13')]],
            ['every 13th', [new Token('word', 'every'), new Token('day', '13th')]],
            ...
            ['every 15th workday', [new Token('word', 'every'), new Token('day', '15th'), new Token('word', 'workday')]],
            ['every 1st wed jan', [new Token('word', 'every'), new Token('day', '1st'), new Token('word', 'wed'), new Token('word', 'jan')]],
            ...
            ['every 3rd friday 8pm', [new Token('word', 'every'), new Token('day', '3rd'), new Token('word', 'friday'), new Token('hour', '8pm')]],
            ['every 3rd friday', [new Token('word', 'every'), new Token('day', '3rd'), new Token('word', 'friday')]],
            ['every 3 workday', [new Token('word', 'every'), new Token('number', '3'), new Token('word', 'workday')]],
            ...
            ['every first workday', [new Token('word', 'every'), new Token('word', 'first'), new Token('word', 'workday')]],
            ...
            ['every jan 13th', [new Token('word', 'every'), new Token('word', 'jan'), new Token('day', '13th')]],
            ['every last day', [new Token('word', 'every'), new Token('word', 'last'), new Token('word', 'day')]],
            ['every last workday', [new Token('word', 'every'), new Token('word', 'last'), new Token('word', 'workday')]],
            ...
            ['every workday', [new Token('word', 'every'), new Token('word', 'workday')]],
            ['every year', [new Token('word', 'every'), new Token('word', 'year')]],
            ['first workday', [new Token('word', 'first'), new Token('word', 'workday')]],
            ...
            ['last workday', [new Token('word', 'last'), new Token('word', 'workday')]],
