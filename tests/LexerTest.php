...
class LexerTest extends TestCase
{
    public static function dateProvider()
    {
        return [
            ...
            ['28 days after 21 July', [new Token('twoOrMore', '28'), new Token('word', 'days'), new Token('word', 'after'), new Token('twoOrMore', '21'), new Token('word', 'July')]],
            ...
            ['60 days before Dec 31', [new Token('twoOrMore', '60'), new Token('word', 'days'), new Token('word', 'before'), new Token('word', 'Dec'), new Token('twoOrMore', '31')]],
            ['6pm', [new Token('hour', '6pm')]],
            ['6 weeks before 21 Jul', [new Token('twoOrMore', '6'), new Token('word', 'weeks'), new Token('word', 'before'), new Token('twoOrMore', '21'), new Token('word', 'Jul')]],
            ['after 11 days', [new Token('word', 'after'), new Token('twoOrMore', '11'), new Token('word', 'days')]],
            ['daily', [new Token('word', 'daily')]],
            ['end of month', [new Token('word', 'end'), new Token('word', 'month')]],
            ['every 12 hours starting at 9pm', [new Token('word', 'every'), new Token('twoOrMore', '12'), new Token('word', 'hours'), new Token('word', 'starting'), new Token('word', 'at'), new Token('hour', '9pm')]],
            ['every 13th', [new Token('word', 'every'), new Token('ordinal', '13th')]],
            ['every 14 jan, 14 apr, 15 jun, 15 sep', [new Token('word', 'every'), new Token('twoOrMore', '14'), new Token('word', 'jan'), new Token('twoOrMore', '14'), new Token('word', 'apr'), new Token('twoOrMore', '15'), new Token('word', 'jun'), new Token('twoOrMore', '15'), new Token('word', 'sep')]],
            ...
            ['every 5, 15, 25', [new Token('word', 'every'), new Token('twoOrMore', '5'), new Token('twoOrMore', '15'), new Token('twoOrMore', '25')]],
            ['every 2 months', [new Token('word', 'every'), new Token('twoOrMore', '2'), new Token('word', 'months')]],
            ['every 3 days', [new Token('word', 'every'), new Token('twoOrMore', '3'), new Token('word', 'days')]],
            ['every 3 hours', [new Token('word', 'every'), new Token('twoOrMore', '3'), new Token('word', 'hours')]],
            ...
            ['every 3 weekday', [new Token('word', 'every'), new Token('twoOrMore', '3'), new Token('word', 'weekday')]],
            ['every 6 days', [new Token('word', 'every'), new Token('twoOrMore', '6'), new Token('word', 'days')]],
            ['every 6 weeks at 09:00 starting jan 3', [new Token('word', 'every'), new Token('twoOrMore', '6'), new Token('word', 'weeks'), new Token('word', 'at'), new Token('time', '09:00'), new Token('word', 'starting'), new Token('word', 'jan'), new Token('twoOrMore', '3')]],
            ['every afternoon', [new Token('word', 'every'), new Token('word', 'afternoon')]],
            ['every day ending aug 3', [new Token('word', 'every'), new Token('word', 'day'), new Token('word', 'ending'), new Token('word', 'aug'), new Token('twoOrMore', '3')]],
            ['every day', [new Token('word', 'every'), new Token('word', 'day')]],
            ['every day for 3 weeks', [new Token('word', 'every'), new Token('word', 'day'), new Token('word', 'for'), new Token('twoOrMore', '3'), new Token('word', 'weeks')]],
            ['every day from 11 May until 20 May', [new Token('word', 'every'), new Token('word', 'day'), new Token('word', 'from'), new Token('twoOrMore', '11'), new Token('word', 'May'), new Token('word', 'until'), new Token('twoOrMore', '20'), new Token('word', 'May')]],
            ['every day starting aug 3', [new Token('word', 'every'), new Token('word', 'day'), new Token('word', 'starting'), new Token('word', 'aug'), new Token('twoOrMore', '3')]],
            ...
            ['in 1 hour', [new Token('word', 'in'), new Token('one', '1'), new Token('word', 'hour')]],
            ['in 2 hours', [new Token('word', 'in'), new Token('twoOrMore', '2'), new Token('word', 'hours')]],
            ['in 3 weeks', [new Token('word', 'in'), new Token('twoOrMore', '3'), new Token('word', 'weeks')]],
            ['in 6 days', [new Token('word', 'in'), new Token('twoOrMore', '6'), new Token('word', 'days')]],
            ...
            ['jan 13', [new Token('word', 'jan'), new Token('twoOrMore', '13')]],
            ...
            ['today at 11', [new Token('word', 'today'), new Token('word', 'at'), new Token('twoOrMore', '11')]],
